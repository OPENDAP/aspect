program sphadd
    ...
    !-- adds up the coefficients of two SPH files
    ...
    !     call chekcl('|  :r:2:Input model .sph files '
    !    1          //'|-o:r:1:output file (1-2)'
    !    1          //'|')
    ...
    natd1 = (lmx1 + 1)**2
    !     write(6,*) 'lmx1,ndmx1', lmx1,ndmx1
    !     write(6,*) 'maskl1', maskl1
    ...
    natd2 = (lmx2 + 1)**2
    !     write(6,*) 'lmx1,ndmx1', lmx2,ndmx2
    !     write(6,*) 'maskl1', maskl2
